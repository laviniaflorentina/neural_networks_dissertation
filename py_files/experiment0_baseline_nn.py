...
path_plots = "/export/home/ncit/external/tmp_stud3/lavi/neural_networks_dissertation/plots/experiment0_baseline_nn/"
...
X_train_sc, y_train_sc = scale_data(images=X_train, 
                                    labels=y_train, 
                                    number_classes=10)
X_valid_sc, y_valid_sc = scale_data(images=X_validation, 
                                    labels=y_validation, 
                                    number_classes=10)
X_test_sc, _ = scale_data(images=X_test, 
                          labels=y_test, 
                          number_classes=10)
...
plot_train(train_history=history, 
           train=True, 
           validation=True,
           acc_name=path_plots+'ex0_baseline_nn_training_acc.png',
           loss_name=path_plots+'ex0_baseline_nn_training_loss.png')


# predicitons
y_predicted = model.predict_classes(X_test_sc)

plot_confusion_matrix(y_test, y_predicted, classes=np.array(range(10)), normalize=False, image=path_plots+"ex0_baseline_nn_confusion_matrix_notnormalized.png")

plot_confusion_matrix(y_test, y_predicted, classes=np.array(range(10)), normalize=True, image=path_plots+"ex0_baseline_nn_confusion_matrix_normalized.png")

baseline_nn_global_evaluation = global_evaluation(y_test, y_predicted)

baseline_nn_global_evaluation.to_csv(path_plots+"ex0_baseline_nn_global_evaluation.csv")

baseline_nn_global_evaluation

baseline_nn_micro_evaluation = micro_evaluation(y_test, y_predicted)

baseline_nn_micro_evaluation.to_csv(path_plots+"ex0_baseline_nn_micro_evaluation.csv")
...
# image model
plot_model(model, to_file=path_plots+'ex0_baseline_nn_model.png', show_shapes=True, show_layer_names=True)
